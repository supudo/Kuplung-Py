...
def init_glut(argv):
    ...
    print("[Widget Viewer] OpenGL version: " + str(glGetString(GL_VERSION)))
    print("[Widget Viewer] GLSL version: " + str(glGetString(GL_SHADING_LANGUAGE_VERSION)))
    print("[Widget Viewer] Vendor: " + str(glGetString(GL_VENDOR)))
    print("[Widget Viewer] Renderer: " + str(glGetString(GL_RENDERER)))
